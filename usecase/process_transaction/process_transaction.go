...
import (
	"github.com/camila-costa/imersao-gateway/domain/repository"
	"github.com/camila-costa/imersao-gateway/domain/entity"
	"github.com/camila-costa/imersao-gateway/adapter/broker"
)
...
func (p *ProcessTransaction) Execute(input TransactionDtoInput) (TransactionDtoOutput, error) {
	...
	cc, invalidCC := entity.NewCreditCard(input.CreditCardNumber, input.CreditCardName, input.CreditCardExpirationMonth, input.CreditCardExpirationYear, input.CreditCardExpirationCVV)
	if invalidCC != nil {
